...
function collectSkinIndexAttrs(meshes) {
  var _a;
  const skinIndexBonesPairSet = /* @__PURE__ */ new Set();
  const skinIndexNewSkinIndexBonesMapMap = /* @__PURE__ */ new Map();
  for (const mesh of meshes) {
    ...
    if (newSkinIndexBonesMap == null) {
      newSkinIndexBonesMap = /* @__PURE__ */ new Map();
    ...
    let newSkinIndexAttr = (_a = Array.from(newSkinIndexBonesMap).find(
      ([_, bones]) => arrayEquals(bones, mesh.skeleton.bones)
    )) == null ? void 0 : _a[0];
 ...
 */
/*!
 * @pixiv/three-vrm-materials-hdr-emissive-multiplier v3.3.3
 ...
 */
/*!
 * @pixiv/three-vrm-node-constraint v3.3.3
 ...
 */
/*!
 * @pixiv/three-vrm-springbone v3.3.3

 ...
 */
export declare function setAimQuaternion<T extends THREE.Quaternion>(target: T, from: THREE.Vector3, to: THREE.Vector3, aim: THREE.Vector3, up: THREE.Vector3, freezeAxes: [boolean, boolean]): T;

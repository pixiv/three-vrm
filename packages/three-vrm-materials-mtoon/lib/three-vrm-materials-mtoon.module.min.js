...
var O=Object.defineProperty;var S=Object.getOwnPropertySymbols;var C=Object.prototype.hasOwnProperty,P=Object.prototype.propertyIsEnumerable;var R=(l,i,e)=>i in l?O(l,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[i]=e,v=(l,i)=>{for(var e in i||(i={}))C.call(i,e)&&R(l,e,i[e]);if(S)for(var e of S(i))P.call(i,e)&&R(l,e,i[e]);return l};var m=(l,i,e)=>new Promise((t,r)=>{var a=n=>{try{u(e.next(n))}catch(d){r(d)}},s=n=>{try{u(e.throw(n))}catch(d){r(d)}},u=n=>n.done?t(n.value):Promise.resolve(n.value).then(a,s);u((e=e.apply(l,i)).next())});import*as E from"three";import*as b from"three";import*as x from"three";var I={"":3e3,srgb:3001};function L(l,i){parseInt(x.REVISION,10)>=152?l.colorSpace=i:l.encoding=I[i]}var h=class{get pending(){return Promise.all(this._pendings)}constructor(i,e){this._parser=i,this._materialParams=e,this._pendings=[]}assignPrimitive(i,e){e!=null&&(this._materialParams[i]=e)}assignColor(i,e,t){if(e!=null){let r=new b.Color().fromArray(e);t&&r.convertSRGBToLinear(),this._materialParams[i]=r}}assignTexture(i,e,t){return m(this,null,function*(){let r=m(this,null,function*(){e!=null&&(yield this._parser.assignTexture(this._materialParams,i,e),t&&L(this._materialParams[i],"srgb"))});return this._pendings.push(r),r})}assignTextureByIndex(i,e,t){return m(this,null,function*(){return this.assignTexture(i,e!=null?{index:e}:void 0,t)})}};import*as o from"three";var U=`// #define PHONG
